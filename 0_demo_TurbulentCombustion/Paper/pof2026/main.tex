...
would have rewarded as excellence. Random-in-time splits remain the dominant
protocol in the sparse-reconstruction literature. \todo{2D lit-protocol
ablation numbers (job 18079077): same DMF-Gen checkpoint on unseen frames of
\emph{seen} trajectories vs.\ 0.487 held-out; small 3-method
...
regions. \todo{uniform-lattice arm numbers (650-point grid vs.\ 655
scattered, same frames, same checkpoint).}
