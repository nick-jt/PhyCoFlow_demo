...
\todo{PROVISIONAL baseline columns: a frame-index audit
(FIREBENCH\_FRAME\_AUDIT\_2026-09-05) found the baseline cells were scored
on an earlier window of the same held-out tail (fire 36--38\,s younger, no
train/val contamination); matched re-eval job 17955209 replaces them ---
values may shift by up to ${\sim}0.1$, ordering expected stable.}}
\begin{ruledtabular}
\begin{tabular}{lcccccc}
