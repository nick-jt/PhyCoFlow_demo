...
Leakage is selective: it pays only models with the capacity and incentive to
memorize, which is precisely why bad splits \emph{reorder} rankings instead
of lifting all methods equally. \todo{Senseiver protocol-B cell (expected to
collapse from 0.913 toward its 0.17 train loss) + 3-method
shuffled-vs-honest table from the archived pre-fix evaluations.}
