#!/bin/bash
#SBATCH --job-name=kolm2d_baseline
...
# Generic 2D-Kolmogorov baseline launcher.
...
CONFIG=${CONFIG:?set CONFIG=Save_config/kolmogorov2d/...yaml}
STAGE=${LFM_STAGE:-1}
TAG=$(basename "$CONFIG" .yaml)
LOG_FILE="train_kolm_${TAG}_stage${STAGE}_${SLURM_JOB_ID}.log"
