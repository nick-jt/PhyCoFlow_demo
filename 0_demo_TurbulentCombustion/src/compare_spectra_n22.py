...
RUNS = [
 ...
 ("N22 (+spectral)",   "../Save_TrainedModel/JHU/pointcloud_ffm/iclr_jhu_xcube_spec_DemoN22_20260819_143551"),
]
import glob
# resolve actual N22 dir name
RUNS[1] = ("N22 (+spectral)", sorted(glob.glob(
    "../Save_TrainedModel/JHU/pointcloud_ffm/iclr_jhu_xcube_spec_DemoN22_*"))[-1])
